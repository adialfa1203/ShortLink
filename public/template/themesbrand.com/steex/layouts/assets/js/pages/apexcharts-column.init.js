...
function loadCharts() {
    (e = getChartColorsArray("column_chart")) &&
        ...
        (e = getChartColorsArray("column_chart_datalabel")) &&
            ((t = {
                chart: { height: 350, type: "bar", toolbar: { show: !1 } },
            ...
            (chartColumnDatatalabelChart = new ApexCharts(
                document.querySelector("#column_chart_datalabel"),
                t
            )).render()),
        (e = getChartColorsArray("column_stacked")) &&
            ((t = {
                series: [
            ...
            "" != chartColumnStackedChart && chartColumnStackedChart.destroy(),
            (chartColumnStackedChart = new ApexCharts(
                document.querySelector("#column_stacked"),
                t
            )).render()),
        (e = getChartColorsArray("column_stacked_chart")) &&
            ((t = {
                series: [
                    {
                        name: "PRODUCT A",
            ...
            (chartColumnStacked100Chart = new ApexCharts(
                document.querySelector("#column_stacked_chart"),
                t
            )).render()),
        (e = getChartColorsArray("column_grouped_stacked_chart")) &&
            ((t = {
                series: [
                    {
                        name: "Q1 Budget",
            ...
            (columnGroupedStackedChart = new ApexCharts(
                document.querySelector("#column_grouped_stacked_chart"),
                t
            )).render()),
        (e = getChartColorsArray("column_dumbbell_chart")) &&
            ((t = {
                series: [
                    {
                        data: [
                ...
                plotOptions: {
                    bar: { isDumbbell: !0, columnWidth: 3, dumbbellColors: e },
                },
                legend: {
                    show: !0,
            ...
            "" != columnDumbbellChart && columnDumbbellChart.destroy(),
            (columnDumbbellChart = new ApexCharts(
                document.querySelector("#column_dumbbell_chart"),
                t
            )).render()),
        (e = getChartColorsArray("column_markers")) &&
            ((t = {
                series: [
                    {
                        name: "Actual",
                ...
                legend: {
                    ...
                    markers: { fillColors: e },
                },
            }),
            "" != chartColumnMarkersChart && chartColumnMarkersChart.destroy(),
            (chartColumnMarkersChart = new ApexCharts(
                document.querySelector("#column_markers"),
                t
            )).render()),
        (e = getChartColorsArray("column_rotated_labels")) &&
            ((t = {
                series: [
                    {
                        name: "Servings",
            ...
            (chartColumnRotateLabelsChart = new ApexCharts(
                document.querySelector("#column_rotated_labels"),
                t
            )).render()),
        (e = getChartColorsArray("column_nagetive_values")) &&
            ((t = {
                series: [
                    {
                        name: "Cash Flow",
                ...
                plotOptions: {
                    bar: {
                        colors: {
                            ranges: [
                                { from: -100, to: -46, color: e[1] },
                                { from: -45, to: 0, color: e[2] },
                            ],
                        },
                        columnWidth: "80%",
                    },
            ...
            (chartNagetiveValuesChart = new ApexCharts(
                document.querySelector("#column_nagetive_values"),
                t
            )).render());
    (e = getChartColorsArray("column_range")) &&
        ((t = {
            series: [
                {
                    data: [
        ...
        "" != chartBarChart && chartBarChart.destroy(),
        (chartBarChart = new ApexCharts(
    ...
    var e = getChartColorsArray("chart-year");
    function s(e, t) {
        var a = [],
            r = [];
        if (e.w.globals.selectedDataPoints[0]) {
            for (
                var o = e.w.globals.selectedDataPoints, s = 0;
                s < o[0].length;
                s++
            ) {
                var l = o[0][s],
    ...
    var t = {
        ...
        a = new ApexCharts(document.querySelector("#chart-year"), t);
    a.render(),
        new ApexCharts(document.querySelector("#chart-quarter"), {
            series: [{ data: [] }],
            chart: {
                id: "barQuarter",
                height: 330,
        ...
        a.addEventListener("dataPointSelection", function (e, t, a) {
            var r = document.querySelector("#chart-quarter"),
                o = document.querySelector("#chart-year");
            1 !== a.selectedDataPoints[0].length ||
                r.classList.contains("active") ||
        ...
        a.addEventListener("updated", function (e) {
            s(e, "barQuarter");
        }),
        (e = getChartColorsArray("column_distributed")) &&
            ((t = {
                series: [{ data: [21, 22, 10, 28, 16, 21, 13, 30] }],
                chart: {
                    height: 350,
                    type: "bar",
                    events: { click: function (e, t, a) {} },
                },
                colors: e,
    ...
    (a = getChartColorsArray("column_group_labels")) &&
        ...
        (chartColumnGroupLabelsChart = new ApexCharts(
