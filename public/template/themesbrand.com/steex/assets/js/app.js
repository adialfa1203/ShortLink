...
document
    ...
    .addEventListener("submit", function (e) {
        e.preventDefault();
        var t = this.getAttribute("action"),
            o = document.querySelector("#message"),
            n = document.querySelector("#email").value;
        o.style.display = "none";
        var i = document.querySelector("#submit");
        i.insertAdjacentHTML("beforebegin", ""), (i.disabled = !0);
        var l = new XMLHttpRequest();
        l.open("GET", t + "?email=" + n),
            (l.onload = function () {
                200 === l.status &&
                    ((o.innerHTML =
                        '<div class="alert alert-success pb-0"><fieldset><div id="success_page"><h3>You are now subscribed!</h3></div></fieldset></div>'),
                    (o.style.display = "block"),
                    (i.disabled = !1),
                    null !== l.responseText.match("subscribed") &&
                        setTimeout(function () {
