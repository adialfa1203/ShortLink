                                ...
                                <div id="genques-collapseOne" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                        <ul>
                                            ...
                                            <li>halaman itu sendiri, adalah tautan pendek Go.Link. Ini berarti Anda
                                                mendapatkan semua metrik pelacakan</li>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="genques-collapseTwo" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <li><strong>5. Ketik nama microsite/alamat microsite nya dan klik Hapus
                                                Microsite</strong></li>
                                    </div>
                                </div>
                            </div>
