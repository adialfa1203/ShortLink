              ...
              <nav class="navbar navbar-expand-lg">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <div class="banner-text">
                        <h1 style="color: white; font-size: 40px;">Bantuan & Dukungan | Pengumuman</h1>
                    </div>
                </div>
                            ...
                            <div class="accordion-item ">
                                ...
                                <div id="genques-collapseOne" class="accordion-collapse collapse show" aria-labelledby="genques-headingOne" data-bs-parent="#genques-accordion">
                                    <div class="accordion-body">
                                        <h1>Selamat datang di S.id - Pemberi Layanan Penyingkat Tautan dan Pembangun Microsite</h1>
                                    
                                        <p>Halo Pengguna S.id,</p>
                                        <p>Kami ingin memberi tahu Anda bahwa kami telah melakukan beberapa perbaikan dalam cara kami beroperasi dan telah memperbarui Syarat dan Ketentuan serta Kebijakan Privasi kami untuk mencerminkan perubahan ini. Perbaikan-perbaikan ini termasuk:</p>
                                    
                                        <ul>
                                            <li><strong>Fitur Baru: Microsite</strong> - Kami dengan bangga meluncurkan fitur terbaru kami, Microsite. Fitur ini berfungsi sebagai jembatan antara pembuat konten, pemilik bisnis, merek, pendidik, dan aktivis media sosial dengan pengikut mereka.</li>
                                            <li><strong>Perubahan dalam cara tautan S.id berfungsi</strong> - Kami telah mengubah arah pengembangan S.id. Tidak hanya sebagai penyingkat tautan, S.id sekarang juga merupakan pembangun microsite yang dapat digunakan untuk membuat tautan di bio media sosial Anda lebih menarik dan informatif.</li>
                                            <li><strong>Perbaikan Sistem Keseluruhan</strong> - Dengan memperbarui Syarat dan Ketentuan serta Kebijakan Privasi, kami memastikan bahwa layanan S.id digunakan dengan benar, terintegrasi dengan komunitas, dan memberikan layanan kelas dunia.</li>
                                        </ul>
                                    
                                        <p>Kami mendorong Anda untuk membaca Syarat dan Ketentuan lengkap kami <a href="link_ke_syarat_dan_ketentuan">di sini</a> dan Kebijakan Privasi <a href="link_ke_kebijakan_privasi">di sini</a>.</p>
                                    
                                        <p>Harap pastikan bahwa Anda menerima perubahan ini melalui popup setelah Anda masuk ke situs kami. Ini akan membantu Anda dan komunitas kami memaksimalkan fitur-fitur yang baru. Jika Anda tidak menerima perubahan tersebut, Anda tidak akan dapat terus menggunakan layanan kami hingga Anda menerimanya.</p>
                                    
                                        <p>Jika Anda memerlukan bantuan lebih lanjut, jangan ragu untuk menghubungi kami di <a href="mailto:helpdesk@S.id">helpdesk@S.id</a></p>
