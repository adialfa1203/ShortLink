              ...
              <nav class="navbar navbar-expand-lg">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <div class="banner-text">
                        <h1 style="color: white; font-size: 40px;">Bantuan & Dukungan | Penagihan & Langganan</h1>
                    </div>
                </div>
                            ...
                            <div class="accordion-item ">
                                ...
                                <div id="genques-collapseOne" class="accordion-collapse collapse show" aria-labelledby="genques-headingOne" data-bs-parent="#genques-accordion">
                                    <div class="accordion-body">
                                        ...
                                        <ul>
                                            <li><strong>1. Kustomisasi Nama URL</strong> - Anda dapat mengganti nama URL hingga 30 kali per bulan.</li>
                                            <li><strong>2. Mengganti Alamat Tujuan Shortlink</strong> - Anda dapat mengganti alamat tujuan shortlink hingga 3 kali per bulan.</li>
                                            ...
                                            <li><strong>8. Total Statistik Visitor</strong></li>
                                            <li><strong>9. Tampilan Rentang Analitik</strong> - Sampai dengan 60 hari.</li>
                                            <li><strong>10. Retensi Analitik</strong> - Data analitik dapat disimpan hingga 180 hari ke belakang.</li>
                                            <li><strong>11. Bebas Iklan</strong></li>
                                    </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="genques-collapseTwo" class="accordion-collapse collapse" aria-labelledby="genques-headingTwo" data-bs-parent="#genques-accordion">
                                    <div class="accordion-body">
                                        ...
                                        <li><strong>2. Silahkan Login dahulu dengan klik Masuk/Daftar sebelah kanan atas</strong></li>
                                        <li><strong>3. Pilih paket yang kamu butuhkan</strong></li>
                                        <li><strong>4. Klik process payment</strong></li>
                                        <li><strong>5. Pilih metode pembayaran</strong></li>
                                        <li><strong>6. Selamat, pembayaran Anda berhasil</strong></li>
                                        <li><strong>7. Riwayat pembayaran Anda akan ada di pengaturan - berlangganan.</strong></li>
                                        <li><strong>8. Luar biasa! Kini Anda bisa menikmati semua fitur yang ada.</strong></li>
                                    </div>
                                </div>
                            </div>
