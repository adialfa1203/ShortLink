                ...
                <div class="card" style="border: 1px solid var(--tb-border-color-translucent); padding: 0px;">
                    <div class="card-body">
                        <div class="d-flex">
                            ...
                            <div class=" col-9 d-flex flex-row justify-content-end">
                                ...
                                <button type="submit" class="btn btn-primary me-3 btn-sm" onclick="archive({{ $row->id }})"><i class="bi bi-archive-fill"></i>
                                    Arsipkan</button>
                            </div>
                        </div>
                        <a>
                    ...
                    <div class="card-footer">
                        <div class="d-flex">
                            ...
                            <div class=" col-9 d-flex flex-row justify-content-end">
                                <button type="button" class="btn btn-light  me-3 btn-sm" data-bs-toggle="modal" data-bs-target="#TimeModal" data-link="{{ $row->url_key }}"><span data-bs-toggle="tooltip" data-bs-placement="left" title="Tautan berbasis waktu"><i class="fa-solid fa-clock"></i>&nbsp;Atur waktu</span></button>
                    ...
                    <form id="updateTime">
                        <div id="TimeModal" class="modal fade Time" tabindex="-1" aria-labelledby="TimeModalLabel" aria-hidden="true" style="display: none;">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="col-lg-12 mb-3">
                                            ...
                                            <input type="datetime-local" class="form-control" name="deactivated_at" id="deactivated_at" q placeholder="Ubah tanggal" data-key="{{$row->url_key}}">
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-light" data-bs-dismiss="modal">Tutup</button>
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-body">
                                                        <div class="row g-3">
                                                            ...
                                                            <div class="countdown-input-subscribe">
                                                                <label class="platform copy-button" data-platform="copy"
                                                                    data-url="{{ $row->default_short_url }}"
                                                                    data-id-copy="{{ $i }}"
                                                                    data-clipboard-text="{{ $row->default_short_url }}">
                                                                    <i class="bi bi-clipboard-fill"></i> &nbsp; Copy
                                                                </label>
                                                            </div>
                                                            ...
                                                            <div class="countdown-input-subscribe">
                                                                <label class="platform"
                                                                    onclick="window.open(` https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=${document.getElementById('default_short_url{{ $i }}').innerText}`)"><i
                                                                        class="bi bi-qr-code"></i> &nbsp; QR Code</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="col-lg-12 mb-3">
                                                    ...
                                                    <input type="datetime-local" class="form-control"
                                                        name="deactivated_at" id="deactivated_at" q
