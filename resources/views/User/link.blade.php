                ...
                <form action="/archive/{{ $row->id }}">
                    ...
                    <div class="col-lg-12">
                        <div class="card" style="border: 1px solid var(--tb-border-color-translucent); padding: 0px;"
                            ...
                            <!-- /.modal -->
                            <div id="tombol-modal-{{ $row->id }}" class="modal fade zoomIn modal-sm" tabindex="-1"
                                aria-labelledby="zoomInModalLabel" aria-hidden="true" style="display: none;">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                            ...
                            <p class="d-none" id="default_short_url{{ $i }}">{{ $row->default_short_url }}
                            </p>
                            @if($userType === 'no')
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body text-center">
                                                    ...
                                                    <p class="card-text text-muted">Dengan fitur kustom anda dapat mengubah tautan anda sesuai selera, seperti
                                                        mengubahnya menjadi nama yang mudah ingat agar mempermudah anda untuk mengakses</p>
                                                </div>
                                                <div class="card-footer text-center">
                                                    <a href="/subscribe-product-user" style="color: red;"> Mulai
                                                        Berlangganan? </a>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-light"
                                                    data-bs-dismiss="modal">Tutup</button>
                                                <button id="submitTime" data-key="{{ $row->url_key }}"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div
                                                            ...
                                                            <button type="button" class="btn btn-primary me-3 btn-sm"
                                                                data-bs-target="#arsip{{ $row->id }}"
                                                                data-bs-toggle="modal"><i class="bi bi-archive-fill"></i>
                                                                Arsipkan</button>
                                                        </div>
                                                        <br>
                                                        <a>
