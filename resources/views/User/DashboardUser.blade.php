                                        ...
                                        <div class="row g-3">
                                            <div class="card-body">
                                                ...
                                                <h6 class="card-title">Nama yang telah diubah/bulan
                                                    ...
                                                    <br>
                                                    <h6 for="AmountInput" class="card-title">Nama tautan/bulan
                                                        <span class="tooltip-icon" data-tooltip="Kuota nama tautan ini menjumlah tautan yang telah dibuat selama satu bulan ">
                                                            <i class="bi bi-exclamation-circle align-baseline ms-1 fs-sm"></i>
                                                        </span>
                                                    </h6>
                                                    <div class="progress">
