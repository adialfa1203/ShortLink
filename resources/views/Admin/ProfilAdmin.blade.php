                                ...
                                <div>
                                    ...
                                    <div class="text-center">
                                        <div class="profile-user position-relative d-inline-block mx-auto">
                                            <img src="{{ asset($admin->profile_picture ? 'storage/' . $admin->profile_picture : 'profile_pictures/default.jpg') }}" alt="{{ $admin->name }}" class="avatar-lg rounded-circle object-fit-cover border-0 img-thumbnail user-profile-image">
