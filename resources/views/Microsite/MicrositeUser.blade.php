                    ...
                    <div class="wrapper row  align-items-center">
                        <div class="avatar-md col-xl-1 col-lg-1 col-md-1 col-sm-1 col-12">
                            <div class="avatar-title">
                                <img src="{{ asset('template/themesbrand.com/steex/layouts/assets/images/sidebar/img-1.png') }}" style="width: 180%; height: 70%;" alt="Gambar">
                            </div>
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-body">
                                                <div class="row g-3">
                                                    ...
                                                    <div class="countdown-input-subscribe">
                                                        <label class="platform" data-platform="copy" @if ($row->oneShortUrl) data-url="{{ $row->oneShortUrl->destination_url }}"
                                                    ...
                                                    <div class="countdown-input-subscribe">
                                                        <a id="tombol-modal" onclick="tombolmodal('{{ $row->id }}')" type="button" data-bs-toggle="modal" data-bs-target="#tombol-modal-{{ $row->id }}" data-id="{{ $row->id }}"><i class="bi bi-qr-code"></i> &nbsp; QR Code</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
