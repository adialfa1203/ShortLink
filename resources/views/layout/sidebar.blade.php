    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a href="apps-calendar.html" class="nav-link menu-link"> <i class="ph-calendar"></i>
                ...
                <li class="nav-item">
                    <a href="#sidebarEcommerce" class="nav-link menu-link collapsed"
                ...
                <li class="nav-item">
                    <a href="apps-file-manager.html" class="nav-link menu-link"> <i
                            class="ph-folder-open"></i> <span data-key="t-file-manager">File Manager</span>
                    </a>
                </li>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarErrors">
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a href="auth-503.html" class="nav-link" data-key="t-503"> 503
                                            </a>
                                        </li>
                                        <li class="nav-item">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="ui-profile.html" class="nav-link"
                                            data-key="t-profile">Profile</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="ui-counter.html" class="nav-link"
                                            data-key="t-counter">Counter</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
