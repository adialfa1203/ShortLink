                                                ...
                                                <form action="{{ route('updatePassword') }}" method="POST">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="position-relative auth-pass-inputgroup">
                                                            <input name="name" type="text" class="form-control pe-5 password-input" onpaste="return false" placeholder="Masukkan Nama Lengkap" id="name-input">                                                            
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="position-relative auth-pass-inputgroup">
                                                            <input name="email" type="email" class="form-control pe-5 email-input" onpaste="return false" placeholder="Masukkan Email" id="email-input">                                                           
                                                        </div>
                                                    </div>
