                    ...
                    <div class="col-lg-12">
                        ...
                        <!-- end Modal bagikan-->                        
                                        ...
                                        <button type="button" class="btn btn-primary me-3 btn-sm"
                                            ...
                                            Arsipkan</button>
                                        {{-- <button type="button" id="archiveBtn" class="btn btn-primary me-3 btn-sm"
                                            onclick="{{ $row->id }}"><i class="bi bi-archive-fill"></i>
                                            Arsipkan</button> --}}
                                    </div>
                                </div>
                                <a>
...
{{-- <script>
    $(document).ready(function() {
        var selectId = $('#archiveBtn').val()
        $('#archiveBtn').click(function() {
            Swal.fire({
            title: 'Apakah Anda Ingin Mengarsip Tautan?',
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "{{route('archive', ':id')}}.replace(":id", selectId),
                    type: 'POST',
                    data: {
                        id: selectId
                    }
