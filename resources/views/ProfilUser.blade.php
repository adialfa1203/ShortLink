...
<!-- Mirrored from themesbrand.com/steex/layouts/pages-profile-settings.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 10 Aug 2023 01:47:14 GMT -->
<head>
...
<div class="vertical-overlay"></div>
                        ...
                        <div class="dropdown ms-sm-3 header-item topbar-user">
                            <button type="button" class="btn shadow-none" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="d-flex align-items-center">
                                    <img class="rounded-circle header-profile-user" src="{{asset ('template/themesbrand.com/steex/layout/assets/images/users/32/avatar-1.jpg') }}" alt="Header Avatar">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-12">
                                ...
                                <div class="card-body pt-0 mt-n5">
                                    <div class="text-center">
                                        <div class="profile-user position-relative d-inline-block mx-auto">
                                            <img src="{{asset ('template/themesbrand.com/steex/layout/assets/images/users/32/avatar-1.jpg') }}" alt="" class="avatar-lg rounded-circle object-fit-cover border-0 img-thumbnail user-profile-image">
                                    ...
                                    <div class="card-body">
                                        <form action="javascript:void(0);">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        <label for="birthDateInput" class="form-label">Konfirmasi kata sandi baru</label>
                            ...
                            <div class="col-3">
                                <span class="badge bg-body-secondary border border-info text-info">
                                    <i class="bi bi-box-arrow-left"></i>
                                    <button class="btn btn-sm" style="font-size: inherit;">Logout</button>
                                </span>
                            </div>
    ...
    <!-- JAVASCRIPT -->
    <script src="{{ asset ('template/thmesbrand.com/steex/layouts/assets/libs/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
...
<!-- Mirrored from themesbrand.com/steex/layouts/pages-profile-settings.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 10 Aug 2023 01:47:17 GMT -->
</html>